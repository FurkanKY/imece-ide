...
Multi-Agent IDE has no telemetry, analytics or automatic error reporting.
...
current user account. They are not returned to the UI or sent to any Multi-Agent
...
user action. A receipt is stored under the opened project's ignored `.magent/`
